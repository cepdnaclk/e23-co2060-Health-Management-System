...
import {
  ...
  receptionistConfirmAppointment,
...
router.put("/api/reception/appointments/:appointmentId/confirm", authRequired, requireRole("receptionist"), receptionistConfirmAppointment);
